...
var selected_keyword, data_series;

// Function for rendering a graph
function graphRenderer(data_series, name){
	...
	var data = [{"name": "EmoSense", "pointStart": Date.UTC(2006,0,1,0,0,0,0),  "data": data_series, "pointInterval": 86400000}];
	option.series = data;
...
$(document).ready(function(){
    ...
    data_series = [1,2,3,4];
   	name = 'Red';
    graphRenderer(data_series, name);
